        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                <View style={{ alignItems: "center", flexDirection: "row", paddingTop: "5%" }}>
                    ...
                    <View style={{ alignItems: "flex-end", flexDirection: "column", flex: 1 }}>
                        <View >
                            <Text style={styles.partDropdown}>Choose your gender</Text>
                            <Text style={styles.partDropdown}>Are you healthy?</Text>
                            <Text style={styles.partDropdown}>Are you a native English speaker?</Text>
                            <Text style={styles.partDropdown}>Where are you currently located?</Text>
                        </View>
                    </View>
